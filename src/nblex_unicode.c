 ...
 **/
int
nblex_unicode_utf8_string_put_char(nblex_unichar c,
...
/**
 * nblex_unicode_utf8_string_get_char:
 ...
 */
int
nblex_unicode_utf8_string_get_char(const unsigned char *input, size_t length,
...
static int nblex_unicode_is_letter(long c);
static int nblex_unicode_is_basechar(long c);
static int nblex_unicode_is_ideographic(long c);
static int nblex_unicode_is_combiningchar(long c);
static int nblex_unicode_is_digit(long c);
static int nblex_unicode_is_extender(long c);


/**
 * nblex_unicode_is_xml11_namestartchar:
 ...
 **/
int
nblex_unicode_is_xml11_namestartchar(nblex_unichar c)
{
...
/**
 * nblex_unicode_is_xml10_namestartchar:
 * @c: Unicode character to check
 *
 ...
 **/
int
nblex_unicode_is_xml10_namestartchar(nblex_unichar c)
{
  return (nblex_unicode_is_letter(c) ||
          (c == '_'));
}


/**
 * nblex_unicode_is_namestartchar:
 * @c: Unicode character to check
 *
 ...
 **/
int
nblex_unicode_is_namestartchar(nblex_unichar c) {
#ifdef NBLEX_XML_1_1
   return nblex_unicode_is_xml11_namestartchar(c);
#else
   return nblex_unicode_is_xml10_namestartchar(c);
#endif
}


/**
 * nblex_unicode_is_xml11_namechar:
 * @c: Unicode character
 *
 ...
 **/
int
nblex_unicode_is_xml11_namechar(nblex_unichar c)
{
  return (nblex_unicode_is_xml11_namestartchar(c) ||
          (c == 0x002D) || /* '-' */
          (c == 0x002E) || /* '.' */
...
/**
 * nblex_unicode_is_xml10_namechar:
 * @c: Unicode character
 *
 ...
 **/
int
nblex_unicode_is_xml10_namechar(nblex_unichar c)
{
  return (nblex_unicode_is_letter(c) ||
          nblex_unicode_is_digit(c) ||
          (c == 0x002E) || /* '.' */
          (c == 0x002D) || /* '-' */
          (c == 0x005F) || /* '_' */
          nblex_unicode_is_combiningchar(c) ||
          nblex_unicode_is_extender(c));
}


/**
 * nblex_unicode_is_namechar:
 * @c: Unicode character to check
 *
 ...
 **/
int
nblex_unicode_is_namechar(nblex_unichar c)
{
#ifdef NBLEX_XML_1_1
   return nblex_unicode_is_xml11_namechar(c);
#else
   return nblex_unicode_is_xml10_namechar(c);
#endif
}
...
static int
nblex_unicode_is_letter(long c)
{
  return(nblex_unicode_is_basechar(c) ||
         nblex_unicode_is_ideographic(c));
}


static int
nblex_unicode_is_basechar(long c)
{
...
static int
nblex_unicode_is_ideographic(long c)
{
...
static int
nblex_unicode_is_combiningchar(long c)
{
...
static int
nblex_unicode_is_extender(long c)
{
